      ...
      <Dialog as="div" className="relative z-10" onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-gray-50 py-6 text-left align-middle shadow-xl transition-all">
                <Dialog.Title
                  as="h3"
                ...
                <div className="px-6 mt-2">
                  <p className="text-gray-600">
                    You cannot undo once it's canceled.
                  </p>
                </div>
                {/* <hr className="mt-6" /> */}
                <div className="flex mt-6 space-x-4 px-6">
                  <button
                    type="button"
                    className="inline-flex justify-center rounded-md border border-transparent bg-red-200 px-4 py-2 text-sm font-medium text-red-900 hover:bg-red-300"
